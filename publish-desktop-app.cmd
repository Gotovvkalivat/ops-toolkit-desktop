...
powershell -NoProfile -Command "Compress-Archive -Path '%OUTPUT%\*' -DestinationPath '%CD%\release\OPS-Toolkit-Desktop-App-v0.4.0-win-x64.zip' -Force"
if errorlevel 1 goto :error

echo.
echo Desktop build: %OUTPUT%\OPS Toolkit.exe
echo Archive: %CD%\release\OPS-Toolkit-Desktop-App-v0.4.0-win-x64.zip
exit /b 0
